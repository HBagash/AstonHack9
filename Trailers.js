...
function videoTemplate(videodata) {
    ...
    <div class="animeTrailerVideoContainer">
        <div class="animeTrailerVideoInfo">
            <h2 class="trailerText trailerHeader" style="text-shadow: -5px 5px rgb(0 0 0 / 35%); width: 240px;">${trailerInfo.title}</h2>
